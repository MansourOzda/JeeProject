		...
		<div class="col-sm-8 m-4 align-middle">
			<div class="card">
				<div class="card-body">
					...
					<p class="card-text text-dark">E-T�l�phone:<b><%= ObjetClient.getTelephone() %></b></p>
					<button type="button" class="btn btn-primary">Modifier mes coordonn�es</button>
					</div>
				</div>
			</div>
		...
		<div class="col-sm-3  align-middle">
			...
			<div class="card m-2 align-middle">
				<div class="card-body">
					...
					<p class="card-text text-dark">Pr�nom:<b><%= ObjetClient.getPrenom() %></b></p>
