		...
		<div class="carousel-inner">
			<div class="carousel-item active slides">
				...
				<div class="carousel-caption d-none d-md-block">
					<h1>iKoniK V7</h1>
					<a href="#ancre-v1">Voir les caract�ristiques</a>
				</div>
			</div>
			<div class="carousel-item slides">
				...
				<div class="carousel-caption d-none d-md-block">
					<h1>iKoniK P2</h1>
					<a href="#ancre-v2">Voir les caract�ristiques</a>
				</div>
			</div>
			<div class="carousel-item slides">
				...
				<div class="carousel-caption d-none d-md-block">
					<h1>iKoniK L3</h1>
					<a href="#ancre-v3">Voir les caract�ristiques</a>
				</div>
			</div>
		</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col">
				...
				<h3>Poids</h3>
				<br>
				<h3>Capacit� de chargement</h3>
				<br>
				<h3>Affichage</h3>
				<br>
				<h3>Le r�seau superchargeur</h3>
				<br>
				<h3>Garantie</h3>
				<br>
			</div>
		...
		<div class="row" style="text-align: center;">
			<div class="col">
				...
				<p style="text-align: center;">De 0 � 100 km/h</p>
			</div>
			<div class="col">
				<h2 style="text-align: center;">907 litres</h2>
				<p style="text-align: center;">Capacit� de chargement</p>
			</div>
			<div class="col">
